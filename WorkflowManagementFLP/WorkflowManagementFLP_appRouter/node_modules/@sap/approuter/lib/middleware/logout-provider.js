...
module.exports = {
  ...
  callServiceLogoutPaths: function(session) {
    ...
    for (var serviceTag in logoutServices) {
      ...
      var serviceCredentials = businessServiceUtils.getCredentials(serviceTag);
...
function logout(app, req, session) {
  ...
  module.exports.callServiceLogoutPaths(session);
