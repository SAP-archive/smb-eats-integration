...
function applyRewriteRule(req, route, routerConfig) {
  ...
  if (destination) {
    if (route.destination === '*'){
      var hostname = urlUtils.getAppRouterHost(req);
      var destinationHostPattern = configurationUtils.constructRegExp(process.env['DESTINATION_HOST_PATTERN']);
      var destinationHostPatternMatches = destinationHostPattern.exec(hostname);
